...
export const SERVER_IP = '10.11.1.3';
...
function updateNavVisibility() {
  ...
  if (currentPath === '/login' || currentPath === '/signup' || currentPath === '/2fa' || currentPath === '/nickname' || currentPath === '/42oauth-redirect' || currentPath === '/offline_game') {
